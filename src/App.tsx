  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-[#0B0F19]/80 backdrop-blur-md border-b border-white/10">
      ...
      <div className="flex items-center gap-4">
        <button
          onClick={onDemo}
          className="px-5 py-2 text-sm font-medium text-teal-50 bg-teal-500/10 border border-teal-500/20 rounded-full hover:bg-teal-500/20 transition-all shadow-sm"
        >
          Book Demo
        </button>
      </div>
        ...
        callbacks: {
          onopen: async () => {
            ...
            try {
              ...
              const processor = audioCtxRef.current.createScriptProcessor(
                4096,
                1,
                1,
              );
              ...
              processor.onaudioprocess = (e) => {
                ...
                if (sampleRate !== 16000) {
                  ...
                  for (let i = 0; i < newLength; i++) {
                    pcm16[i] =
                      Math.min(1, Math.max(-1, data[Math.floor(i * ratio)])) *
                      0x7fff;
                  }
                } else {
          ...
          onmessage: async (message: LiveServerMessage) => {
            ...
            if (base64Audio && playbackCtxRef.current) {
              ...
              const buffer = playbackCtxRef.current.createBuffer(
                1,
                float32.length,
                24000,
              );
            ...
            if (message.serverContent?.interrupted) {
              nextTimeRef.current = playbackCtxRef.current
          ...
          onclose: (closeEvent: any) => {
            ...
            setStatus(
              closeEvent
                ? `CLOSED: ${closeEvent.code || ""} ${closeEvent.reason || ""}`
                : "IDLE",
            );
            stopAudio();
          },
      ...
      <div className="relative overflow-hidden rounded-[24px] border border-[rgba(255,255,255,0.1)] bg-white/[0.03] backdrop-blur-md shadow-2xl">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[rgba(255,255,255,0.05)] bg-white/[0.01]">
          <div className="flex items-center gap-2.5">
            <div
              className={`w-2 h-2 rounded-full ${isActive ? "bg-teal-400 animate-pulse shadow-[0_0_8px_rgba(45,212,191,0.8)]" : "bg-gray-500"}`}
            />
          ...
          <div className="flex flex-col items-center justify-center space-y-4 py-6">
            ...
            <div className="text-center">
              <p className="text-sm font-medium text-white mb-1">
                {isActive ? "AI Agent is Active" : "Have a question?"}
              </p>
              <p className="text-xs text-gray-400">
                {isActive ? "Tap square to end call" : "Tap the mic to talk to our AI Sales Agent"}
              </p>
            </div>
          </div>
        </div>
    ...
    <>
        ...
        <div className="w-full max-w-7xl mx-auto z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="text-left w-full max-w-2xl">
            ...
            >
              ...
              <span className="text-[10px] sm:text-xs font-semibold tracking-wider text-teal-50 uppercase">
                Nexus Web Agency Live
              </span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold tracking-tight leading-[1.05] mb-8"
            >
              <span className="text-white">Websites that work.</span>
              <br />
            ...
            >
              We build premium websites for small businesses, featuring embedded
              AI agents that handle customer inquiries, take orders, and capture
              leads 24/7.
            </motion.p>
            ...
            >
              <button
                onClick={onDemo}
                className="w-full sm:w-auto px-8 py-3.5 text-sm font-medium text-[#0B0F19] bg-teal-400 hover:bg-teal-300 transition-all rounded-full flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(45,212,191,0.3)]"
              >
      ...
      <section className="py-12 border-y border-[rgba(255,255,255,0.05)] bg-[#0B0F19]/50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-center text-xs font-mono tracking-widest text-gray-500 mb-8 uppercase">
            Trusted by leaders at
          </p>
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            {/* Placeholder Logos */}
            <div className="flex items-center gap-2 font-bold text-xl tracking-tight">
              <div className="w-6 h-6 bg-white rounded-sm" /> ACME Corp
            </div>
            <div className="flex items-center gap-2 font-bold text-xl tracking-tight">
            ...
            <div className="flex items-center gap-2 font-bold text-xl tracking-tight">
              <div className="w-6 h-6 bg-white rotate-45" /> NexusLink
            </div>
            <div className="flex items-center gap-2 font-bold text-xl tracking-tight">
              <div className="w-6 h-6 border-2 border-white rounded-br-xl" />{" "}
              InnovateSpace
            </div>
            <div className="flex items-center gap-2 font-bold text-xl tracking-tight hidden md:flex">
              <div className="w-6 h-6 bg-white rounded-tl-xl rounded-br-xl" />{" "}
              CloudSync
            </div>
          </div>
        </div>
  ...
  const features = [
    {
      ...
      description:
        "Seamlessly switch between ultra-low latency voice streaming and rich text chat in the same session. Your agent never sleeps.",
      icon: Mic,
    ...
    },
    {
      ...
      description:
        "We train your AI on your own business documents, menus, and product catalogs so it knows everything about your business.",
      icon: Database,
    ...
    },
    {
      ...
      description:
        "Generates secure Stripe payment links directly inside the conversation.",
      icon: CreditCard,
      className: "md:col-span-1 lg:col-span-1",
      viz: (
    ...
    },
    {
      ...
      description:
        "Detects complex inquiries and instantly notifies your team via email or SMS to step in.",
    ...
    <section id="features" className="py-20 md:py-24 px-6 bg-[#0B0F19]">
      <div className="max-w-6xl mx-auto">
        <div className="mb-12 md:mb-16 text-center md:text-left">
          ...
          <p className="text-gray-400 text-lg font-light max-w-2xl mx-auto md:mx-0">
            Everything you need to turn visitors into booked revenue, built
            natively into one single lightweight snippet.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, i) => (
            <motion.div
              ...
              key={feature.title}
              className={`relative overflow-hidden rounded-3xl bg-white/[0.02] border border-[rgba(255,255,255,0.05)] p-8 group hover:border-[rgba(255,255,255,0.1)] hover:bg-white/[0.03] transition-all shadow-xl min-h-[220px] ${feature.className}`}
            >
...
function Metrics() {
  return (
    <section
      id="metrics"
      className="py-20 md:py-24 px-6 border-y border-white/5 bg-[#070A12]"
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-gray-400 text-lg font-light mb-8 max-w-lg leading-relaxed">
            Passive lead generation relies on hoping the user fills out a
            10-field form. Nexus actively hunts for the conversion by asking the
            right questions, handling pricing objections, and accelerating the
            deal.
          </p>
          <ul className="space-y-4">
            {[
              "4.2x average increase in leads captured",
              "Zero configuration deployment",
              "Connects directly to your email or existing CRM",
            ].map((item, i) => (
              <li
                key={i}
        ...
        <div className="relative w-full sm:aspect-square md:aspect-video lg:aspect-square bg-white/[0.02] rounded-3xl border border-[rgba(255,255,255,0.05)] p-6 sm:p-8 flex flex-col justify-between overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-teal-500/10 blur-[100px] pointer-events-none" />
          <div className="relative z-10">
            <h3 className="text-xs sm:text-sm font-mono text-gray-400 uppercase tracking-widest mb-1">
              Conversion Rate
            </h3>
            <div className="text-2xl sm:text-3xl md:text-4xl font-light text-white mb-6 sm:mb-8">
              Outbound vs Nexus
            </div>
          </div>
          ...
          <div className="relative z-10 flex items-end gap-4 sm:gap-6 h-48 sm:h-64 mt-auto">
            ...
            {/* Old Method */}
            <div className="w-full h-full flex flex-col justify-end items-center gap-2 group relative z-10">
              <div className="text-lg sm:text-xl text-gray-500 font-medium text-center transition-colors">
                1.2%
              </div>
              ...
              <div className="text-[10px] sm:text-xs text-center text-gray-500 uppercase tracking-widest font-mono">
                Form
              </div>
            </div>
            ...
            {/* Nexus Method */}
            <div className="w-full h-full flex flex-col justify-end items-center gap-2 group relative z-10">
              <div className="text-2xl sm:text-3xl font-medium text-center text-white drop-shadow-md">
                5.4%
              </div>
              <div className="flex-1 w-full flex items-end">
                <motion.div
              ...
              <div className="text-[10px] sm:text-xs text-center text-white uppercase tracking-widest font-mono">
                Agent
              </div>
            </div>
          </div>
...
function Testimonials() {
  const testimonials = [
    {
      quote:
        "Nexus rebuilt our plumbing business website and added the AI agent. We're booking 3x more appointments because the AI handles middle-of-the-night calls and schedules them directly.",
      author: "Sarah Jenkins",
      role: "Owner, Jenkins Plumbing",
    },
    {
      quote:
        "Our old website was just a digital brochure. Now, customers land on the site, ask AI about our catering menu, and place orders directly. It feels like having a full-time sales rep.",
      author: "Michael Chang",
      role: "Founder, Lotus Catering",
    },
    {
      quote:
        "I was skeptical about AI, but Nexus made it easy. The agent knows our entire inventory. If a customer asks if we have a specific part in stock, it checks and replies instantly.",
      author: "David Miller",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="p-8 rounded-3xl bg-white/[0.02] border border-[rgba(255,255,255,0.05)] flex flex-col justify-between"
            >
              <div className="mb-6">
...
function Pricing({ onDemo }: { onDemo: () => void }) {
  return (
    <section id="pricing" className="py-20 md:py-24 px-6 max-w-5xl mx-auto">
      <div className="text-center mb-16">
        <h2 className="text-3xl font-bold tracking-tight mb-4 text-white">Simple, transparent pricing.</h2>
        <p className="text-gray-400">Everything you need to automate your business online.</p>
      </div>

      <div className="max-w-md mx-auto">
        <div className="relative overflow-hidden rounded-[2rem] bg-white/[0.02] border border-[rgba(255,255,255,0.05)] p-8 hover:border-[rgba(255,255,255,0.1)] transition-all shadow-2xl">
          <div className="absolute top-0 right-0 w-64 h-64 bg-teal-500/10 blur-[100px] pointer-events-none" />
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm text-gray-400 mb-8 border-b border-white/10 pb-8">
              Complete AI website with auto-response agent and integrated payments.
            </p>

            <ul className="space-y-4 mb-8">
              {[
                "Custom landing page design",
                "Embedded AI Sales Agent",
            ...
            <button
              onClick={onDemo}
              className="w-full py-4 text-sm font-medium text-[#0B0F19] bg-teal-400 hover:bg-teal-300 transition-all rounded-full shadow-[0_0_20px_rgba(45,212,191,0.3)]"
            >
              Get Started
            </button>
          </div>
...
function FAQ() {
  const faqs = [
    {
      q: "How long does it take to train the AI for my business?",
      a: "During the web design process, we'll ask for your FAQs, menus, or service lists. We train the AI so it's ready to go the moment your site launches.",
    },
    {
      q: "Does it support multiple languages?",
      a: "Yes. Nexus natively comprehends and responds in over 40 languages with ultra-low latency, recognizing language switches in real-time.",
    },
    {
      q: "What if the AI doesn't know the answer?",
      a: "If the AI encounters a question it is not trained on, it politely takes a message from the customer and forwards the inquiry directly to your email or SMS.",
    },
    {
      q: "Can I customize the agent's voice and tone?",
      a: "Absolutely. You can select from 15 professional voice models and define a strict system prompt to control formatting, tone (e.g., direct, helpful, energetic), and hard constraints.",
    },
  ];
  ...
  return (
    <section className="py-20 md:py-24 px-6 border-t border-white/5 bg-[#0B0F19]">
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        <h2 className="relative text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight mb-6">
        ...
        <p className="relative text-base sm:text-lg text-gray-400 font-light max-w-xl mx-auto mb-10 px-4">
          Let us build a stunning website for your small business, supercharged
          with an AI assistant that drives sales on autopilot.
        </p>
        <div className="relative flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            onClick={onDemo}
            className="w-full sm:w-auto px-8 py-4 text-sm font-medium text-[#0B0F19] bg-teal-400 hover:bg-teal-300 transition-all rounded-full text-center shadow-[0_0_20px_rgba(45,212,191,0.3)]"
          >
            Book a demo
          </button>
        </div>
...
function Modal({ type, onClose }: { type: "demo"; onClose: () => void }) {
  ...
  const content = {
    demo: {
      title: "Book a Demo",
      desc: "See how our AI-powered websites can transform your business.",
      btn: "Schedule Demo",
    },
  }[type];
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm">
      ...
      >
        ...
        <h3 className="text-xl font-medium text-white mb-2 pr-8">
          {content?.title}
        </h3>
        ...
        >
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-600 focus:outline-none focus:border-white/30"
            />
          </div>
          <div>
            <label className="block text-xs font-medium text-gray-500 mb-1.5">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2.5 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-600 focus:outline-none focus:border-white/30 min-h-[80px]"
            />
          </div>
          <button
            type="submit"
            className="w-full py-3 text-sm font-medium text-black bg-white hover:bg-gray-200 transition-colors rounded-lg mt-2"
          >
            {content?.btn}
          </button>
        </form>
  ...
  return (
    <div className="bg-[#0B0F19] min-h-screen text-white selection:bg-teal-500/30 relative">
      ...
      <main>
        ...
        <Metrics />
        <Testimonials />
        <Pricing onDemo={() => setModalType("demo")} />
        <FAQ />
